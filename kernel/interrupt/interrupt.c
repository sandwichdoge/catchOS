...
private
void ISR_COM1(size_t* return_reg, struct cpu_state* unused) {
    _dbg_break();
}

private
void ISR_DEVICE_NOT_AVAILABLE(size_t* return_reg, struct cpu_state* unused) {
