    ...
    for (tag = (struct multiboot_tag *)(addr + 8); tag->type != MULTIBOOT_TAG_TYPE_END;
        ...
        switch (tag->type) {
            ...
            case MULTIBOOT_TAG_TYPE_MODULE:
                ...
                _memcpy(&_kinfo.mods[modcount++], (char *)tag, sizeof(struct multiboot_tag_module));
                break;
...
public
void kinfo_set_phys_mem_lower(size_t phys_mem_lower) { _kinfo.phys_mem_lower = phys_mem_lower; }

public
void kinfo_set_phys_mem_upper(size_t phys_mem_upper) { _kinfo.phys_mem_upper = phys_mem_upper; }
