// https://github.com/idispatch/raster-fonts/blob/master/font-12x16.c
#include "font.h"
...
#endif /* FONT_H_ */
#endif
unsigned char console_font_7x9[] = {
...
unsigned char* font_get_char(unsigned char c) { return &console_font_7x9[c * ((FONT_W * FONT_H) / 8)]; }
